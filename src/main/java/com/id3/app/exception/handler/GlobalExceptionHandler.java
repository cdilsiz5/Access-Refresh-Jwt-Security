package com.id3.app.exception.handler;

import com.id3.app.exception.ApiException;
import com.id3.app.exception.ValidationException;
import com.id3.app.response.ErrorResponse;
